...
- Name: dashboard.spec.ts >> Pretzel Dashboard >> should display agent management sections
- Location: tests\dashboard.spec.ts:43:7
...
Call log:
  - navigating to "http://localhost:3000/admin/agents", waiting until "load"
